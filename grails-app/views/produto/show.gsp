            ...
            <div class="dialog">
                <table>
                    <tbody>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="produto.carro.label" default="Carro" /></td>
                            
                            <td valign="top" class="value"><g:link controller="carro" action="show" id="${produtoInstance?.carro?.id}">${produtoInstance?.carro?.encodeAsHTML()}</g:link></td>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="produto.validade.label" default="Validade" /></td>
                            
                            <td valign="top" class="value"><g:formatDate date="${produtoInstance?.validade}" /></td>
