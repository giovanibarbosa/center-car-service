            ...
            <div class="dialog">
                <table>
                    <tbody>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="cliente.dataNascimento.label" default="Data Nascimento" /></td>
                            
                            <td valign="top" class="value"><g:formatDate date="${clienteInstance?.dataNascimento}" /></td>
                        ...
                        <tr class="prop">
                            ...
                            <td valign="top" class="value"><g:link controller="endereco" action="show" id="${clienteInstance?.endereco?.id}">${clienteInstance?.endereco?.encodeAsHTML()}</g:link></td>
