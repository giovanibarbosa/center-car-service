...
<html>
    <head>
        ...
        <title>Alterar Cartao de Credito</title>
    </head>
    <body>
        <div class="nav">
            <span class="menuButton"><a class="home" href="${createLink(uri: '/')}">Pagina Principal</a></span>
            <span class="menuButton"><g:link class="list" action="list">Vendas a Cartao de Credito</g:link></span>
        </div>
        <div class="body">
            <h1>Alterar Cartao de Credito</h1>
            ...
            <g:form method="post" >
                ...
                <g:hiddenField name="version" value="${cartaoDeCreditoInstance?.version}" />
                <div class="dialog">
                    <table>
                        <tbody>
