            ...
            <div class="dialog">
                <table>
                    <tbody>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="funcionario.totalEmSalariosAtrasados.label" default="Total Em Salarios Atrasados" /></td>
                            
                            <td valign="top" class="value">${fieldValue(bean: funcionarioInstance, field: "totalEmSalariosAtrasados")}</td>
