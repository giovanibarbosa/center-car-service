        ...
        if (salarioInstance) {
            if (params.version) {
                ...
                if (salarioInstance.version > version) {
                    ...
                    salarioInstance.errors.rejectValue("version", "default.optimistic.locking.failure", [message(code: 'salario.label', default: 'Salario')] as Object[], "Another user has updated this Salario while you were editing")
